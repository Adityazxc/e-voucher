<div class="modal fade" id="addCustomerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id='addCustomer' action="<?php echo base_url('ccc_corp/add_data'); ?>"
...
<!-- <script type="text/javascript">
    ...
    rupiah.addEventListener('keyup', function (e) {
        var originalValue = unformatRupiah(this.value);
        this.value = formatRupiah(originalValue, 'Rp. ');

        // Set nilai asli pada atribut data-original-value (opsional)
        this.setAttribute('data-original-value', originalValue);
    });

    function unformatRupiah(rupiah) {
        return rupiah.replace(/[^\d]/g, ''); // Hapus semua karakter non-angka
    }
    /* Fungsi formatRupiah */
